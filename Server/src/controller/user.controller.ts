...
// const addUser = async (req: any, res: any, next: NextFunction) => {};

// /* GET users listing. */
// router.post("/adduser", async (req, res) => {
//   const { phone, email, role, name } = req.body;
//   if (!phone || !role || !name)
//     return res.status(422).send({ message: "Bad arguments" });
...
//           return res
//             .status(422)
//             .send({ message: "Phone or email is already used" });
//         else
//           switch (role) {
//             case "ADMIN":
//               new UserModel({
...
//                   return res
//                     .status(500)
//                     .send({ message: "Error saving :" + err.message });
//                 });

//               break;

//             case "VILLAGE":
//               const { address, group, ward, district, city, workers } =
//                 req.body;
//               new UserModel({
//                 name,
//                 phone,
