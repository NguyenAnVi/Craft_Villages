...
const ProductCreate = (props: props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }): Promise<void> => {
      try {
        if (user?.accessToken) {
          const res = await createProduct(user.smallHolderId, { avatar: file, ...values }, user.accessToken)
          if (res) {
      ...
      >
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className={cx('form-btn')}>
            ...
            <Button color="secondary" border="round" to={config.routesAdminSmallHolder.adminSmallHolderProduct}>
              Hủy
            </Button>
          </div>
        </form>
